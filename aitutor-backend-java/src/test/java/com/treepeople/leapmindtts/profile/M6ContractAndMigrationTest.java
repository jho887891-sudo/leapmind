...
class M6ContractAndMigrationTest {
    ...
    @Test void migrationsDocumentedContractAndOpenApiStayFrozen() throws Exception {
        String v3 = read("src/main/resources/db/migration/V6__create_m6_user_events.sql");
        String v4 = read("src/main/resources/db/migration/V7__create_m6_user_profiles.sql");
        String v5 = read("src/main/resources/db/migration/V8__create_m6_user_knowledge_mastery.sql");
