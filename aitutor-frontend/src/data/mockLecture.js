...
// ─── PPT 结构 Mock（讲课生成结果，格式对齐后端 SLIDE_SCHEMA_DESC）──────
...
export const mockPPTStructure = {
  ...
  slides: [
    ...
    },
    {
      ...
      interaction: {
        type: 'choice_question',
        question: '如果梯子底部离墙 2m，顶端高度是多少？',
        options: ['A. √23 ≈ 4.8m', 'B. √21 ≈ 4.58m', 'C. 5m', 'D. 4m'],
        answer: 'B',
      },
    },
    {
